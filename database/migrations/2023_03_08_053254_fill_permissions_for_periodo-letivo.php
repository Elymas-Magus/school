...
class FillPermissionsForPeriodoLetivo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPeriodoLetivo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.periodo-letivo',
            'admin.periodo-letivo.index',
            'admin.periodo-letivo.create',
            'admin.periodo-letivo.show',
            'admin.periodo-letivo.edit',
            'admin.periodo-letivo.delete',
            'admin.periodo-letivo.bulk-delete',
        ]);
