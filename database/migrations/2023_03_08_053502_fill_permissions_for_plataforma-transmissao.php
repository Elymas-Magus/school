...
class FillPermissionsForPlataformaTransmissao extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPlataformaTransmissao constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.plataforma-transmissao',
            'admin.plataforma-transmissao.index',
            'admin.plataforma-transmissao.create',
            'admin.plataforma-transmissao.show',
            'admin.plataforma-transmissao.edit',
            'admin.plataforma-transmissao.delete',
            'admin.plataforma-transmissao.bulk-delete',
        ]);
