...
class FillPermissionsForNotificacaoTipo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNotificacaoTipo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.notificacao-tipo',
            'admin.notificacao-tipo.index',
            'admin.notificacao-tipo.create',
            'admin.notificacao-tipo.show',
            'admin.notificacao-tipo.edit',
            'admin.notificacao-tipo.delete',
            'admin.notificacao-tipo.bulk-delete',
        ]);
