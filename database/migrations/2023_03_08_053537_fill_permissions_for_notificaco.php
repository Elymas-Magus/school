...
class FillPermissionsForNotificaco extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNotificaco constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.notificaco',
            'admin.notificaco.index',
            'admin.notificaco.create',
            'admin.notificaco.show',
            'admin.notificaco.edit',
            'admin.notificaco.delete',
            'admin.notificaco.bulk-delete',
        ]);
