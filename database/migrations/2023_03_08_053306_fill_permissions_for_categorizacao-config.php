...
class FillPermissionsForCategorizacaoConfig extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorizacaoConfig constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorizacao-config',
            'admin.categorizacao-config.index',
            'admin.categorizacao-config.create',
            'admin.categorizacao-config.show',
            'admin.categorizacao-config.edit',
            'admin.categorizacao-config.delete',
            'admin.categorizacao-config.bulk-delete',
        ]);
