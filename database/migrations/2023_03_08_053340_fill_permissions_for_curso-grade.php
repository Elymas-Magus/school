...
class FillPermissionsForCursoGrade extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCursoGrade constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.curso-grade',
            'admin.curso-grade.index',
            'admin.curso-grade.create',
            'admin.curso-grade.show',
            'admin.curso-grade.edit',
            'admin.curso-grade.delete',
            'admin.curso-grade.bulk-delete',
        ]);
