...
class FillPermissionsForTurnoEscolar extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTurnoEscolar constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.turno-escolar',
            'admin.turno-escolar.index',
            'admin.turno-escolar.create',
            'admin.turno-escolar.show',
            'admin.turno-escolar.edit',
            'admin.turno-escolar.delete',
            'admin.turno-escolar.bulk-delete',
        ]);
