...
class FillPermissionsForPlanejamentoAula extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPlanejamentoAula constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.planejamento-aula',
            'admin.planejamento-aula.index',
            'admin.planejamento-aula.create',
            'admin.planejamento-aula.show',
            'admin.planejamento-aula.edit',
            'admin.planejamento-aula.delete',
            'admin.planejamento-aula.bulk-delete',
        ]);
