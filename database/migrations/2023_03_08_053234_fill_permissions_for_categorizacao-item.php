...
class FillPermissionsForCategorizacaoItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorizacaoItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorizacao-item',
            'admin.categorizacao-item.index',
            'admin.categorizacao-item.create',
            'admin.categorizacao-item.show',
            'admin.categorizacao-item.edit',
            'admin.categorizacao-item.delete',
            'admin.categorizacao-item.bulk-delete',
        ]);
