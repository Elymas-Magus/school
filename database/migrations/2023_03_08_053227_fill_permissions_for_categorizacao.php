...
class FillPermissionsForCategorizacao extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorizacao constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorizacao',
            'admin.categorizacao.index',
            'admin.categorizacao.create',
            'admin.categorizacao.show',
            'admin.categorizacao.edit',
            'admin.categorizacao.delete',
            'admin.categorizacao.bulk-delete',
        ]);
