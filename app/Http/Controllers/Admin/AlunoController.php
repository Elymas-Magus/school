...
class AlunoController extends Controller
{
    ...
    public function index(IndexAluno $request)
    {
        ...
        $data = AdminListing::create(Aluno::class)->processRequestAndGet(
            ...
            ['bol_aee', 'celular', 'data_matricula', 'data_nascimento', 'email_responsavel', 'escola_id', 'id', 'registro', 'telefone', 'turma_id', 'user_id'],

            // set columns to searchIn
            ['celular', 'email_responsavel', 'id', 'registro', 'telefone']
        );
